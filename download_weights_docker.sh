...
if [ ! -f "models/Stable-diffusion/juggernaut_reborn.safetensors" ]; then
    ...
    curl --progress-bar -L -o models/Stable-diffusion/juggernaut_reborn.safetensors \
...
if [ ! -f "models/ic-light/IC-Light.SD15.FBC.safetensors" ]; then
    echo "Downloading IC-Light.SD15.FBC..."
    curl --progress-bar -L -o models/ic-light/IC-Light.SD15.FBC.safetensors \
...
if [ ! -f "models/ic-light/IC-Light.SD15.FC.safetensors" ]; then
    echo "Downloading IC-Light.SD15.FC..."
    curl --progress-bar -L -o models/ic-light/IC-Light.SD15.FC.safetensors \
...
if [ ! -f "models/u2net/u2net_human_seg.onnx" ]; then
    echo "Downloading u2net_human_seg..."
    curl --progress-bar -L -o models/u2net/u2net_human_seg.onnx \
...
if [ ! -f "models/Lora/more_details.safetensors" ]; then
    echo "Downloading more_details..."
    curl --progress-bar -L -o models/Lora/more_details.safetensors \
...
if [ ! -f "models/Lora/SDXLrender_v2.0.safetensors" ]; then
    echo "Downloading SDXLrender_v2.0..."
    curl --progress-bar -L -o models/Lora/SDXLrender_v2.0.safetensors \
